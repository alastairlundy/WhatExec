...
public interface IExecutableFileResolver
{
    ...
    /// </summary>
    /// <param name="inputFileNames">An array of strings representing the names of the executable files to locate.</param>
    /// <param name="directorySearchOption">Specifies whether to search all directories or only the top-level directory.</param>
    /// <param name="cancellationToken">A cancellation token that can be used to cancel the operation.</param>
    ...
    Task<IReadOnlyDictionary<string, FileInfo>> GetExecutableFilesAsync(string[] inputFileNames, SearchOption directorySearchOption, CancellationToken cancellationToken);

    /// <summary>
    /// Asynchronously enumerates the file information of specified executable files.
    /// </summary>
    /// <param name="inputFileNames">An array of strings representing the names of the executable files to locate.</param>
    /// <param name="directorySearchOption">Specifies whether to search all directories or only the top-level directory.</param>
    /// <param name="cancellationToken">A cancellation token that can be used to cancel the operation.</param>
    ...
    /// </returns>
    Task<(bool, IReadOnlyDictionary<string, FileInfo>)> TryGetExecutableFilesAsync(string[] inputFileNames, SearchOption directorySearchOption,
        CancellationToken cancellationToken);
}
